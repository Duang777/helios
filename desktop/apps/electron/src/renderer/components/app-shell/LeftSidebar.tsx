    ...
    >
      ...
      >
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            将删除「{pendingDeleteWorkspace?.name ?? '该项目'}」在 Helios 中保存的会话、自动任务、MCP、Skills 与 Helios 工作区配置；空白项目的 Helios 托管项目文件也会被删除。本地项目根目录、附加目录和附加文件只会移除关联，不会删除原始文件。删除后无法恢复。
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
      ...
      >
        ...
        <div className="flex flex-col items-center gap-1.5">
          ...
          <Tooltip>
            ...
            <TooltipContent side="right">业务对话</TooltipContent>
          </Tooltip>
        </div>
