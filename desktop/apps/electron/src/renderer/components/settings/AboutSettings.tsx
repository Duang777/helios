...
export function AboutSettings(): React.ReactElement {
  return (
    <SettingsSection
      title="关于 Helios"
      description="业务工作流编译器与可审计运行时的桌面入口"
    >
      <SettingsCard>
        ...
        <SettingsRow label="运行时">
          <span className="text-sm text-muted-foreground">Electron + React → Helios API</span>
        </SettingsRow>
        <SettingsRow
          label="开源协议"
        ...
        <SettingsRow label="Helios 源码">
          <a
            href={HELIOS_REPO_URL}
            target="_blank"
            rel="noopener noreferrer"
            className="text-sm text-primary hover:underline"
          >
