...
/** localStorage 缓存键（Helios 新 key，避免沿用 Proma 的 dark 缓存） */
const THEME_CACHE_KEY = 'helios-theme-mode'
const THEME_STYLE_CACHE_KEY = 'helios-theme-style'
const INTERFACE_VARIANT_CACHE_KEY = 'helios-interface-variant'
