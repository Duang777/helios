        ...
        {variant.id === 'default' ? (
          ...
          <div className="relative size-7">
            {[0, 60, 120, 180, 240, 300].map((deg) => (
              <div
                key={deg}
                className="absolute left-1/2 top-1/2 size-2 -translate-x-1/2 -translate-y-1/2 bg-white"
                style={{
                  transform: `translate(-50%, -50%) rotate(${deg}deg) translateY(-9px) rotate(45deg)`,
                }}
              />
            ))}
          </div>
