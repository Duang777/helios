/**
 * AgentIslandApp —— Helios 工作脉冲（Work Pulse）
 *
 * 将原本偏“独立玩具窗”的灵动岛收敛为 Helios 的可扫读工作状态条：
...
export function AgentIslandApp(): React.ReactElement {
  ...
  const compactTitle = priority?.title ?? 'Helios Agent'
      ...
      <div ref={containerRef} className="pulse-shell pulse-shell-expanded" style={{ width: 500 }}>
        <header className="pulse-header">
          ...
          <div className="pulse-header-actions">
            ...
            <button type="button" className="pulse-icon-button" onClick={openMain} title="打开 Helios">
